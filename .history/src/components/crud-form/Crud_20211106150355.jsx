...
export default function Crud({ addOrEdit, editData, borrarDatos }) {
  const [tarea, setTarea] = useState("");
  const [tareasExist, setTareaExist] = useState([]);
  ...
  useEffect(() => {
   async function getTareas(){
      ...
      snapshot.forEach(doc =>{
        ...
        setTareas([...tareas,  { nameTarea: doc.data().nameTarea,id: doc.id,}])
      })
   }
   getTareas();
  }, []);
  ...
  // const showTareas = (doc)=>{
  //   setTareas([...tareas, doc.data()])
